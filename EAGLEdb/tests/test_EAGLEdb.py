...
class TestBactDBCreating(unittest.TestCase):
    ...
    def test_get_taxonomy(self):
        ...
        result["family"], result["genus"], result["species"], result["strain"] = \
            bactdb_creation.get_taxonomy(tax_f_name, INPUT_DIR, remove_tax_f=False)
    ...
    def test_get_16S_fasta(self):
        ...
        result = bactdb_creation.get_16S_fasta(rna_f_name, INPUT_DIR, strain=self.test_tax["strain"],
                                               remove_rna_f=False)
